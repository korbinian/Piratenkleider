 ...
 */
 ...
 $default_footerlink_liste = array(
     __( 'Deutschland', 'piratenkleider' )  => array(
        ...
        'sublist'   => array(
            __('Baden-Württemberg', 'piratenkleider' ) => 'http://www.piratenpartei-bw.de/',
            ...
            __('Thüringen', 'piratenkleider' ) => 'http://www.piraten-thueringen.de/'
        )
     ),
     __('International', 'piratenkleider' ) => array(
         ...
         'sublist' => array(
             __('Argentinien', 'piratenkleider' ) => 'http://www.partidopirata.com.ar/',
              ...
              __('Dänemark', 'piratenkleider' ) => 'http://piratpartiet.dk/',
             ...
             __('Österreich', 'piratenkleider' ) => 'http://piratenpartei.at/',
             ...
             __('Rumänien', 'piratenkleider' ) => 'http://www.partidulpiratilor.ro/',
             ...
             __('Weißrussland', 'piratenkleider' ) => 'http://belpirat.blog.tut.by/',
      ...
      __('International (mit Flaggen)', 'piratenkleider' ) => array(
         ...
         'sublist' => array(
             ...
             '<img src="'.get_template_directory_uri().'/images/flags/br.png" width="16" height="11" alt=""> '.__('Brasilien', 'piratenkleider') => 'http://www.partidopirata.org/',
              ...
              '<img src="'.get_template_directory_uri().'/images/flags/dk.png" width="16" height="11" alt=""> '.__('Dänemark', 'piratenkleider') => 'http://piratpartiet.dk/',
             ...
             '<img src="'.get_template_directory_uri().'/images/flags/at.png" width="16" height="11" alt=""> '.__('Österreich', 'piratenkleider') => 'http://piratenpartei.at/',
             ...
             '<img src="'.get_template_directory_uri().'/images/flags/ro.png" width="16" height="11" alt=""> '.__('Rumänien', 'piratenkleider') => 'http://www.partidulpiratilor.ro/',
             ...
             '<img src="'.get_template_directory_uri().'/images/flags/kr.png" width="16" height="11" alt=""> '.__('Südkorea', 'piratenkleider') => 'http://pirateparty.kr/',
             ...
             '<img src="'.get_template_directory_uri().'/images/flags/tr.png" width="16" height="11" alt=""> '.__('Türkei', 'piratenkleider') => 'http://www.korsanpartisi.org/',
             ...
             '<img src="'.get_template_directory_uri().'/images/flags/by.png" width="16" height="11" alt=""> '.__('Weißrussland', 'piratenkleider') => 'http://belpirat.blog.tut.by/',
    ...
    'Brandenburg' => array(
        ...
        'sublist' => array(
            ...
            '<acronym title="Regionalverband">RV</acronym> Südbrandenburg' => 'http://sued.piratenbrandenburg.de/',
        )
    ),
    ...
    'Nordrhein-Westfalen' => array(
      ...
      'Rheinland-Pfalz' => array(
        ...
        'sublist' => array(
            ...
            '<acronym title="Kreisverband">KV</acronym> Landau/Südliche Weinstraße' => 'http://wiki.piratenpartei.de/RP:Kreisverband_Landau/S%C3%BCdliche_Weinstra%C3%9Fe',
       ...
       'fussteil'   => array(
           ...
           'fields' => array(
              'default_footerlink_show' => array(
                  ...
                  'label'   => __( 'Im Fußteil eine Liste von Links zu Seiten der Piratenpartei anzeigen', 'piratenkleider' ),
       ...
       'sidebar'   => array(
           ...
           'fields' => array(
              ...
              'zeige_sidebarpagemenu' => array(
                  ...
                  'label'   => __( 'Menü mit allen Seiten in der Sidebar anzeigen, auch wenn diese nicht dem Hauptmenu zugeordnet und gegliedert sind', 'piratenkleider' ),
       ...
       'startseite'   => array(
           ...
           'fields' => array(
              ...
              'aktiv-startseite-alteartikel' => array(
                  'type'    => 'bool',
                  'title'   => __( 'Ältere Artikel', 'piratenkleider' ),
                  'label'   => __( 'Liste mit älteren Artikeln anzeigen', 'piratenkleider' ),
                  'default' => $defaultoptions['aktiv-startseite-alteartikel'],
              ),
              'aktiv-startseite-alteartikel-num' => array(
                  'type'    => 'number',
                  'title'   => __( 'Zahl ältere Artikel', 'piratenkleider' ),
                  'label'   => __( 'Anzahl der zu verlinkenden älteren Artikel.', 'piratenkleider' ),
             ...
             'teaser_maxlength' => array(
                  ...
                  'label'   => __( 'Maximale Textl&auml;nge für Artikelauszüge auf der Startseite.', 'piratenkleider' ),
       ...
       'socialmedia'   => array(
           ...
           'fields' => array(
              ...
              'social_feed' => array(
                  ...
                  'default' => $defaultoptions['social_feed'],
              ),  
              'twitterwidget'  => array(
                  'type'    => 'section',
              ...
              'feed_twitter' => array(
                  ...
                  'default' => $defaultoptions['feed_twitter'],
       ...
       'metaangaben'   => array(
           ...
           'fields' => array(
               'meta-author' => array(
                  ...
                  'default' => $defaultoptions['meta-author'],
              ),  
                'meta-description' => array(
                  ...
                  'default' => $defaultoptions['meta-description'],
              ),  
                'meta-keywords' => array(
                  'type'    => 'text',
                  ...
                  'default' => $defaultoptions['meta-keywords'],
              ),  
          )
       ),
       'anonymitaet'   => array(
