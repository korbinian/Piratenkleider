...
<p><?php _e( 'Dieser Artikel ist Passwortgeschützt. Bitte gib das Passwort ein um die Kommentare zu sehen.', 'twentyten' ); ?></p>
<?php 
	return;
endif; ?>
...
<?php else : if ( ! comments_open() ) : ?>
	<p><?php _e( 'Die Kommentarfunktion ist gesperrt', 'twentyten' ); ?></p>
<?php endif; ?>
